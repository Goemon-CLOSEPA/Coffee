...
3. おはようございますの挨拶から入り、今日の価格と前日比を明記すること。
4. この価格変動から考えられる簡単な市況感や、クリプト層・ロースター向けのインサイト（約200〜300文字）を含めること。
5. 添付するチャート画像（過去1ヶ月の推移）と一緒に見られることを前提としたトーンにすること。
6. ハッシュタグ（#CoffeeFutures #Crypto #コーヒー相場 など）は必ず文章の一番最後に配置すること。
"""
